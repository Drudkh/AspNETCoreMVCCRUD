...
namespace Asp.netCoreMVCCRUD.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            // Bind - позволяет установить выборочную привязку отдельных значений.
            // ModelState.IsValid - мы узнаем, проходит модель валидацию или нет, и зависимости от результата совершаем те или иные действия.
            // RedirectToAction позволяет перейти к определенному действию определенного контроллера. Он также позволяет задать передаваемые параметры
